...
import { USER_VIP, USER_VIP } from '../../utils/dict'
...
export const post: APIRoute = async context => {
  ...
  Object.hasOwnProperty.call(USER_VIP, key.replace(/sk-/gi, '')) && (key = USER_VIP[key.replace(/sk-/gi, '') as keyof typeof USER_VIP].key)
